...
class BatchGenerator:
    ...
    """
    def __init__(self, problem_seqs, correct_seqs, num_problems, batch_size, **kwargs):
    ...
    def shuffle(self):
        temp = list(zip(self.problem_seqs, self.correct_seqs))
        random.shuffle(temp)
        self.problem_seqs, self.correct_seqs = zip(*temp)
        self.reset_cursor()
